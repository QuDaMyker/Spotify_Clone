...
public class ArtistsFragment extends Fragment {
    ...
    private List<itemTabLayout_Artists> getItemTabLayoutList() {
        List<itemTabLayout_Artists> list = new ArrayList<>();
        list.add(new itemTabLayout_Artists(R.drawable.img_singer_1, "Lil Baby", "Nghệ sĩ"));
        list.add(new itemTabLayout_Artists(R.drawable.img_singer_2, "Taylor Swift", "Nghệ sĩ"));
        list.add(new itemTabLayout_Artists(R.drawable.img_singer_3, "Drake", "Nghệ sĩ"));
        list.add(new itemTabLayout_Artists(R.drawable.img_singer_4, "Morgan Wallen", "Nghệ sĩ"));
